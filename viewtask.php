...
<?php
         ...
         $q3=mysqli_query($conn,"SELECT *from task1 where Project_name='$project'");
...
<!--.............................................main content...............................................-->
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php        
                  $q2=mysqli_query($conn,"SELECT distinct Project_name from project");
                ...
                ?>                 
                          <form action="" method="post">
                                       ...
                                       ?>
                                          ...
                                          <input type="submit" class="btn btn-primary ml-3" value="Show" name="selected"/>
                                     </form>
                  ...
                  <?php
                   ...
                   ?>
                            <tr align="center">
                             ...
                             <td><?php echo $x['Ass'];?></td>
                             <td>
                              <i class="fa fa-edit"></i><a href="updatetask.php?ist=<?php echo $x['Task']."&AssTo=".$x['Ass']."&iskey=".$key; ?>" id="a1">Edit</a>
                              </td>
                              <td>
                              <i class="fa fa-trash"></i><a href="delete.php?ist=<?php echo $x['Task']."&iskey=".$key."&AssTo=".$x['Ass']."&taid=".$x['Id']; ?>" id="a2" onclick='return checkdelete()'>delete</a>
                              </td>
  ...
  <script type="text/javascript">
            ...
            function checksend()
            {
                return confirm('are you sure to send this task to Employee?');
            }
        </script>
