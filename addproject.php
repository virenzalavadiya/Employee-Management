...
<!--.............................................main content...............................................-->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <form action="project.php?iskey=<?php echo $key;?>" method="post">
        <div class="container" >
            <div class="row">
              <div class="col"></div>
                <div class="col-5">
                <div class="text-center">
                    ...
                    <label>Project Type:</label><span style="color:red">*</span>  
                        ...
                        <input type="text" class="form-control mb-3" name="project_name" placeholder="Enter project name" maxlength="30" required>
                        ...
                        <select id="type" class="form-control mb-3" id="inlineFormCustomSelectPref" name="project_type" >
                            ...
                            <option value="Application Devlopement">Application Devlopement</option>                           
                        </select>  
                        
                        <label for="start-date">Enter Project start-date:</label><span style="color:red">*</span>
                        <input type="text" class="form-control mb-3" autocomplete="off" id="datepicker" name="start_date" placeholder="Enter project start date" required>
                        
                        <label for="end-date">Enter Project end-date:</label><span style="color:red">*</span>
                        <input type="text" class="form-control mb-4" autocomplete="off" id="datepicker1" name="end_date" placeholder="Enter project end-date"  required>
                        
                        <!-- <div class="float-right"> -->
                        <input type="submit" class="btn btn-primary" value="create" name="submit">&nbsp&nbsp 
                        </div>
                        </div>
                        </div>
                        <div class="col"></div>
