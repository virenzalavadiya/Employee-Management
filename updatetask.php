...
include 'admin_nav.php';
      ...
      $q=mysqli_query($conn,"SELECT * from task1 where Task='$Task_ed'");
      $x=mysqli_fetch_array($q);
      $id=$x['Id'];
      $y=$_GET['AssTo'];   
      
      $q1=mysqli_query($conn,"SELECT Distinct * from employee where Role_id=2 and Emp_name!='$y' ");
...
<!--.............................................main content...............................................-->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="back">
        <form action="edit.php?iskey=<?php echo $key."&ist=".$Task_ed."&isAss=".$Ass."&emid=".$id; ?>" method="post">
        <div class="container" >
            <div class="row">
            <div class="col"></div>
                <div class="col-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" value="<?php echo $x['Task']?>" name="Task" placeholder="Enter the Task" maxlength="30" required>
                        
                        <label for="start-date">Enter task start-date:</label><span style="color:red">*</span>
                        <input type="text" class="form-control mb-3" autocomplete="off" id="datepicker" value="<?php echo $x['Start_date']?>"  name="start_date" placeholder="start date" required>
                        
                        <label for="end-date">Enter task end-date:</label><span style="color:red">*</span>
                        <input type="text" class="form-control mb-4" autocomplete="off" id="datepicker1" value="<?php echo $x['End_date']?>"  name="end_date" placeholder="end-date"  required>
                        ...
                        <input type="submit" class="btn btn-primary" value="Update" name="tsubmit">
                        </div>
                    </div>
                    </div>
                    <div class="col"></div>
