            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php
                  ...
                  $q1=mysqli_query($conn,"SELECT *from client");
                 ...
                 ?>  
                  ...
                  <?php
                   ...
                   ?>
                            <tr align="center">
                            <td><?php echo $x['Client_type'];?></td>
                             <td><?php echo $x['Client_email'];?></td>
                             <td><?php echo $x['Client_name'];?></td>
                             <td>
                              <i class="fa fa-edit"></i><a href="updateclient.php?isc=<?php echo $x['Client_name']."&iskey=".$key; ?>" id="a1">Edit</a>
                              </td>
                              <td>
                              <i class="fa fa-trash"></i><a href="delete.php?isc=<?php echo $x['Client_name']."&iskey=".$key; ?>" id="a2" onclick='return checkdelete()'>delete</a>
                              </td>
                          <?php
                          }
                          ?>
