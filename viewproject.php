            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php
                  ...
                  $q1=mysqli_query($conn,"SELECT *from project");
                  ...
                  <?php
                   ...
                   ?>
                            <tr align="center">
                             ...
                             <td><?php echo $x['Project_type'];?></td>
                             <td><?php echo $x['Start_project'];?></td>
                             <td><?php echo $x['End_project'];?></td>
                             <td>
                              <i class="fa fa-edit"></i><a href="updateproject.php?isp=<?php echo $x['Project_name']."&iskey=".$key; ?>" id="a1">Edit</a>
                              </td>
                              <td>
                              <i class="fa fa-trash"></i><a href="delete.php?isp=<?php echo $x['Project_name']."&iskey=".$key; ?>" id="a2" onclick='return checkdelete()'>delete</a>
                              </td>
